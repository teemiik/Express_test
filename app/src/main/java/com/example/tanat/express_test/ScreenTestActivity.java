...
import static com.example.tanat.express_test.R.color.notification_material_background_media_default_color;
...
public class ScreenTestActivity extends AppCompatActivity {
    ...
    private void show(View v) {
        ...
        fullscreen_content.setTextColor(ContextCompat.getColor(getApplicationContext(), R.color.black));
        fullscreen_content.setText(R.string.vibor);
